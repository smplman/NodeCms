!function($, wysi) {
	...
	var templates = {
		...
		"link": 	"<li>"
				    	...
				    	+ "<a class='btn btn-default' data-wysihtml5-command='createLink' title='Link'><i class='glyphicon glyphicon-link'></i></a>"
		...
		"html":
						"<li>"
							+ "<div class='btn-group'>"
								+ "<a class='btn btn-default' data-wysihtml5-action='change_view' title='Edit HTML'><i class='glyphicon glyphicon-edit'></i></a>"
							+ "</div>"
						+ "</li>",
		"save":
						"<li>"
							+ "<div class='btn-group'>"
								+ "<button type='submit' class='btn btn-default' data-wysihtml5-command='savePage' title='Save Page'><i class='glyphicon glyphicon-floppy-disk'></i></a>"
							+ "</div>"
						+ "</li>"
	};
	...
	Wysihtml5.prototype = {
		...
		initSavePage: function(toolbar) {
			var saveButton = "button[data-wysihtml5-command='savePage']";
			toolbar.find(saveButton).click(function(e) {
				$('[data-form]').submit();
			});
		},
